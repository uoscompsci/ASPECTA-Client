...
class messageSender:
    ...
    def newCircle(self, projector, canvasNo, x, y, radius, coorSys, lineCol, lineWidth, fillCol, sides):
        ele = self.sendMessage(projector, {'call': 'new_circle',
                                           ...
                                           'radius': str(radius),
                                           'coorSys': coorSys,
                                           'lineColor': self.colorString(lineCol[0], lineCol[1], lineCol[2],
                                                                         lineCol[3]),
                                           'lineWidth': str(lineWidth),
                                           'fillColor': self.colorString(fillCol[0], fillCol[1], fillCol[2],
                                                                         fillCol[3]),
                                           'sides': str(sides)})
    ...
    def newPolygon(self, projector, canvasNo, x, y, coorSys, lineColor, lineWidth, fillColor):
        ele = self.sendMessage(projector, {'call': 'new_polygon',
                                           ...
                                           'y': str(y),
                                           'coorSys': coorSys,
                                           'lineColor': self.colorString(lineColor[0], lineColor[1], lineColor[2],
                                                                         lineColor[3]),
                                           'lineWidth': str(lineWidth),
                                           'fillColor': self.colorString(fillColor[0], fillColor[1], fillColor[2],
                                                                         fillColor[3])})
        eleNo = int(ele["elementNo"])
        return eleNo
    ...
    def newRectangleWithID(self, projector, ID, canvasNo, x, y, width, height, coorSys, lineColor, lineWidth,
                           fillColor):
